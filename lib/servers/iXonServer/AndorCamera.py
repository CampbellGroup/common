...
class AndorCamera(object):
    ...
    def get_temperature(self):
        ...
        if (
            ERROR_CODE[error] == "DRV_TEMP_STABILIZED"
    ...
    def set_shutter_mode(self, mode):
        ...
        error = self.dll.SetShutter(
            c.c_int(1), c.c_int(mode_number), c.c_int(0), c.c_int(0)
        )
        if ERROR_CODE[error] == "DRV_SUCCESS":
...
ShutterMode = {"Auto": 0, "Open": 1, "Close": 2}
