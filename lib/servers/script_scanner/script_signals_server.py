...
class ScriptSignalsServer(LabradServer):
    ...
    on_running_script_finished = Signal(
        200005, "signal_on_running_script_finished", "w"
    )
    ...
    # queued scripts
    on_queued_new_script = Signal(
        200010, "signal_on_queued_new_script", "wsw"
    )  # identification, name, order
