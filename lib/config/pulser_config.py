...
class PulserConfiguration:
    ...
    dds_channel_dict['global397'] = DDSChannel(1, (70.0, 100.0), (-63.0, -12.0), 90.0, -33.0)
    dds_channel_dict['radial'] = DDSChannel(2, (90.0, 130.0), (-63.0, -12.0), 110.0, -63.0)
    dds_channel_dict['854DP'] = DDSChannel(3, (70.0, 90.0), (-63.0, -4.0), 80.0, -33.0)
    dds_channel_dict['729DP'] = DDSChannel(4, (150.0, 250.0), (-63.0, -5.0), 220.0, -33.0)
