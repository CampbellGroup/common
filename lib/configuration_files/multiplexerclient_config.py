class multiplexer_config(object):
    ...
    info = {'Channel 1' :(1, '384.230000', (0,0), True),
            ...
            'Channel 4' :(4, '384.230000', (1,0), True),
            'Channel 5': (5, '405.645745', (1,1), True),
            'Channel 6': (6, '320.571975', (1,2), True),
            'Channel 7': (7, '751.526150', (2,0), True),
            'Channel 8': (8, '384.230000', (2,1), True)
            }
