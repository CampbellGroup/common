...
class KeithleyClient(QFrame):
    ...
    def initialize_gui(self):
        ...
        self.volt1widget.spinLevel.valueChanged.connect(
            lambda value=self.volt1widget.spinLevel.value(), chan=1: self.volt_changed(chan, value))
        self.volt2widget.spinLevel.valueChanged.connect(
            lambda value=self.volt2widget.spinLevel.value(), chan=2: self.volt_changed(chan, value))
        self.volt3widget.spinLevel.valueChanged.connect(
            lambda value=self.volt3widget.spinLevel.value(), chan=3: self.volt_changed(chan, value))

        self.amp1widget.spinLevel.valueChanged.connect(
            lambda value=self.amp1widget.spinLevel.value(), chan=1: self.amp_changed(chan, value))
        self.amp2widget.spinLevel.valueChanged.connect(
            lambda value=self.amp2widget.spinLevel.value(), chan=2: self.amp_changed(chan, value))
        self.amp3widget.spinLevel.valueChanged.connect(
            lambda value=self.amp3widget.spinLevel.value(), chan=3: self.amp_changed(chan, value))
