...
from common.lib.clients_py3.qtui.QCustomPowerMeter import MQProgressBar
from common.lib.clients_py3.qtui.QCustomSlideIndicator import SlideIndicator
...
class QCustomWavemeterChannel(QtWidgets.QFrame):
    ...
    def makeLayout(self, name, wmChannel, frequency, stretchedlabel):
        ...
        configtitle = QtWidgets.QLabel("WLM Connections: Channel " + str(wmChannel))
        ...
        if stretchedlabel is True:
            ...
            self.currentfrequency = QtWidgets.QLabel(frequency)
        ...
        exposurelabel = QtWidgets.QLabel('Set Exposure (ms): ')
